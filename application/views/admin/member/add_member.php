                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo site_url('admin/members/add') ?>" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <input class="form-control <?php echo form_error('nama_asli') ? 'is-invalid' : '' ?>" type="text" name="nama_asli" placeholder="Nama Asli" />
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control <?php echo form_error('nama_panggung') ? 'is-invalid' : '' ?>" type="text" name="nama_panggung" placeholder="Nama Panggung" />
                                <div class="invalid-feedback">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control <?php echo form_error('sub_unit') ? 'is-invalid' : '' ?>" type="text" name="sub_unit" placeholder="Sub Unit" />
                                <div class="invalid-feedback">
